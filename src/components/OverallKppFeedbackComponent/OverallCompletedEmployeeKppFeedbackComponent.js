...
const OverallCompletedEmployeeKppFeedbackComponent = () => {
    ...
    const navigateToAllHodKppFeedbackStatusComponent = () => {
        ...
        navigate(`/allcompletedemployeekppfeedback`, { replace: true })
            ...
            <div className="row">
                ...
                <div className="col-sm-8">
                    <a href={BASE_URL_API + `/report/in-progress-hod-kpp-status?empId=${Cookies.get('empId')}`}>
                        <button type="button" className="btn btn-success col-sm-offset-9" disabled={kppMasterResponses?.empKppStatus === "Pending"}>  Download</button></a>
...
export default OverallCompletedEmployeeKppFeedbackComponent;