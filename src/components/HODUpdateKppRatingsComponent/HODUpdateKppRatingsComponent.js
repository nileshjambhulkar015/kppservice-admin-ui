            ...
            <div className="row">
                <Formik initialValues={{
                    ...
                    onSubmit={(values) => {
                        ...
                        const payload = { "kppUpdateRequests": values?.fields, "gmTotalAchivedWeight": totalAchivedWeight, "gmTotalOverallAchieve": totalOverAllAchive, "gmTotalOverallTaskComp": totalOverallTaskComp, gmKppStatus, gmRemark };
                    ...
                    {({ values, setFieldValue }) => {
                        ...
                        const handleTodoChange = (e, i, kppId, kppOverallWeightage, gmOverallTaskComp, kppRating1) => {
